    ...
    flex-col sm:mb-16 mb-6 relative z-[1]'>
      ...
      <div className='w-full md:mt-0 mt-6'>
        <p className={`${styles.paragraph} text-left max-w-[450px]`}>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae necessitatibus, quasi consequuntur, nam quis enim accusantium placeat adipisci sequi, ullam deserunt dicta! Perferendis optio dolores ipsum officia voluptatem, quis molestias?
