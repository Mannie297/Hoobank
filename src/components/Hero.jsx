    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between
          ...
          mt-5`}>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero aliquam, quae quas possimus eligendi nesciunt error dolorem reiciendis hic adipisci provident distinctio doloremque unde amet molestiae, nam in maxime corrupti.
          </p>
      </div>
